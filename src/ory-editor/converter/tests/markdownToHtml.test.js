...
const cases = [
  ...
  },
  {
    ...
    output:
      '<p>Addition der einzelnen Elementarwahrscheinlichkeiten:</p><p><katexblock>P(A)=P\\left(\\left\\{(T;T)\\right\\}\\right)+P\\left(\\left\\{(T;N)\\right\\}\\right)+P\\left(\\left\\{(N;T)\\right\\}\\right)</katexblock></p>\n<p><katexinline>P(A)=\\frac5{20}+\\frac{15}{20}\\cdot\\frac5{19}=\\frac{17}{38}=44,7\\% </katexinline></p>'
  }
]
