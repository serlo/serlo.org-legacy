...
utils_1.createMigration(exports, {
    up: (db) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield db.dropTable('context_route_parameter');
        yield db.dropTable('context_route');
        yield db.dropTable('context');
        yield db.runSql(`DELETE FROM permission WHERE name LIKE "contexter.%"`);
    }),
});
