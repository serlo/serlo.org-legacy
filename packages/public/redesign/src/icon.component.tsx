...
const icons: iconObject  = {
  ...
  faTwitterSquare: faTwitterSquare, faFacebookSquare: faFacebookSquare, faCircle: faCircle, faVideo: faVideo, faCog: faCog, faShareAlt: faShareAlt, faGoogle: faGoogle, faWhatsappSquare: faWhatsappSquare, faCompass: faCompass, faGithubSquare: faGithubSquare
}
