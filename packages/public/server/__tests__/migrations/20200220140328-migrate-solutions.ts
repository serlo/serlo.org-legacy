const {
  migrateState
} = require('../../migrations/20200220140328-migrate-solutions')
                ...
                state: [
                  {
                    ...
                    children: [
                      {
                        text:
                          'Tipp: Versuche die Zeichnung in eine Skizze mit den Punkten '
                      },
                      {
                        type: 'math',
                      ...
                      {
                        text:
                          ' und vier Geraden umzuwandeln, Ã¤hnlich zu den Zeichnungen im Artikel zum '
                      },
                      {
                        type: 'a',
                        href: '/1971',
                ...
                state: [
                  ...
                  },
                  {
                    ...
                    children: [
                      {
                        text:
                          'Die Zeichnung kann in eine Skizze, Ã¤hnlich zu den Skizzen im Artikel zum '
                      },
                      {
                        type: 'a',
                        href: '/1971',
                      ...
                      {
                        text:
                          ', umgeformt werden. Das sieht dann folgendermaÃŸen aus:'
                      }
                    ]
                  }
                ]
                ...
                state: [
                  {
                    ...
                    state: {
                      src:
                        'https://assets.serlo.org/legacy/591326a3943a9_b6b9503240e5c544dae8c9427e2f77166a6c9b32.png',
                      alt: ''
                    }
                  }
                ]
                    ...
                    state: [
                      {
                        ...
                        children: [
                          {
                            text:
                              'AnschlieÃŸend kannst du die gegebenen Werte aus der Angabe den Strecken in der Skizze zuordnen.'
                          }
                        ]
                      }
                    ]
                ...
                state: [
                  {
                    ...
                    state: {
                      src:
                        'https://assets.serlo.org/legacy/591326cf7016b_9f28b189b35c01d5867283b88a04e3ed447b1039.png',
                      alt: ''
                    }
                  }
                ]
                    ...
                    state: [
                      {
                        ...
                        children: [
                          ...
                          {
                            text:
                              ' auszurechnen schreibst du dir am besten nochmal die gegebenen Werte auf. Dazu benutzt du die Zuordnung aus der Skizze oben.'
                          }
                        ]
                      }
                    ]
                    ...
                    state: [
                      {
                        ...
                        children: [
                          ...
                          },
                          {
                            type: 'math',
                            src:
                              '\\displaystyle{\\overline{Z A_1}=9,5m-7,5m = 2m}',
                            inline: false,
                            children: [
                              {
                                text:
                    ...
                    state: [
                      {
                        ...
                        children: [
                          {
                            text:
                              'Suche anschlieÃŸend den passenden Strahlensatz fÃ¼r die gegebenen Strecken.'
                          }
                        ]
                      }
                    ]
                    ...
                    state: [
                      ...
                      },
                      {
                        ...
                        children: [
                          {
                            text:
                              'Stelle den Strahlensatz nach der gesuchten GrÃ¶ÃŸe  '
                          },
                          {
                            type: 'math',
                            src:
                              '\\hspace{0,15cm} h = \\overline{A_2 B_2}\\hspace{0,15cm}',
                            inline: true,
                            children: [
                              {
                                text:
                    ...
                    state: [
                      {
                        ...
                        children: [
                          {
                            text:
                              'Setze die Werte ein und berechne die HÃ¶he fÃ¼r das Haus!'
                          }
                        ]
                      }
                    ]
