...
return [
    ...
    'view_manager' => [
        ...
        'template_map' => [
            'legacy-editor' =>
                __DIR__ . '/../templates/legacy-editor/layout.phtml',
            'layout/de/home' =>
                __DIR__ . '/../templates/layout/de/serlo-home.phtml',
            'layout/en/home' =>
                __DIR__ . '/../templates/layout/en/serlo-home.phtml',
        ...
        'strategies' => ['Zend\View\Strategy\JsonStrategy', 'ViewFeedStrategy'],
    ],
    'controller_plugins' => [
        'factories' => [
    ...
    'service_manager' => [
        'factories' => [
            'Ui\Renderer\PhpDebugRenderer' =>
                __NAMESPACE__ . '\Factory\PhpDebugRenderFactory',
            __NAMESPACE__ . '\Options\BrandHelperOptions' =>
                __NAMESPACE__ . '\Factory\BrandHelperOptionsFactory',
            __NAMESPACE__ . '\Options\TrackingHelperOptions' =>
                __NAMESPACE__ . '\Factory\TrackingHelperOptionsFactory',
            __NAMESPACE__ . '\Options\PageHeaderHelperOptions' =>
                __NAMESPACE__ . '\Factory\PageHeaderHelperOptionsFactory',
        ],
    ],
];
